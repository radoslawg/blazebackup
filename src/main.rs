...
mod tests {
    ...
    fn test_hash_changes_on_modification_time() -> Result<()> {
        ...
        sleep(Duration::from_millis(300)); // Increased sleep time for better reliability across filesystems
        ...
        file.flush()?;
        sleep(Duration::from_millis(600)); // Increased sleep time for better reliability across filesystems
